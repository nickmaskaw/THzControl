...
class MultimeterOld:
    ...
    def create_widget(self, frame, row):
        if not self._widget:
            ...
            self._label   = ttk.Label(frame, text="MultimeterOld:", width=10)
            ...
            print("MultimeterOld widget successfully created")
        else:
            print("MultimeterOld widget already exists")
    ...
    def widget_enable(self):
        ...
        print("MultimeterOld widget enabled")
    ...
    def widget_disable(self):
        ...
        print("MultimeterOld widget disabled")
